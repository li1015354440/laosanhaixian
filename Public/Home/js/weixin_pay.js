...
//  	$('.weixinPayBtn').click();
        $('.weixinPayBtn').click(function(){
            if (playMethod == 'weixin') {
                ...
                var thisBtn = $(this);
                //获取订单id
                var orderId = thisBtn.attr('data-order_id');
                //设置微信安全支付目录
                var safe_pay_dir = 'http://www.zhonghenganyuan.com/laosan/index.php/Home/pay/index/';
                //拼接请求地址
                var pay_url = safe_pay_dir+'order_sn/'+orderId;

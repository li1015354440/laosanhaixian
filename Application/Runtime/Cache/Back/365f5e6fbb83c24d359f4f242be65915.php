   ...
   <a href="<?php echo sortU('list',$filter,$sort,'sort_number');?>" class="<?php echo sortClass($sort,'sort_number');?>">排序</a>
                                ...
                                <?php if(is_array($rows)): $i = 0; $__LIST__ = $rows;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><tr>
                                        <td class="text-center">
                                         ...
                                         <td class="text-left"><?php echo ($row['banner_id']); ?></td>
                                        <td class="text-left">
                                        <img src="/laosan/Public/Thumb/<?php echo ($row['banner_thumb']); ?>" width="100" height="50"></td>
                                        <td class="text-left"><?php echo ($row['sort_number']); ?></td>
                                        <td class="text-right">
                                            <a href="<?php echo U('set',['banner_id'=>$row['banner_id']]);?>" data-toggle="tooltip" title="编辑" class="btn btn-primary"><i class="fa fa-pencil"></i></a>
                                                                                </td>

        ...
        <div class="container-fluid">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form action="<?php echo U('set');?>" method="post" enctype="multipart/form-data" id="form-type" class="form-horizontal">
                        <?php if(isset($data['type_id'])): ?><input type="hidden" name="type_id" value="<?php echo ($data['type_id']); ?>" id="input-type_id"><?php endif; ?>
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="tab-general">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="title" value="<?php echo ($data['title']); ?>" placeholder="类型标题" id="input-title" class="form-control" data-remoteurl="<?php echo U('ajax');?>"/>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="sort_number" value="<?php echo ($data['sort_number']); ?>" placeholder="排序字段" id="input-sort_number" class="form-control" data-remoteurl="<?php echo U('ajax');?>"/>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="hidden" name="type_image" id="input-type_image-value" value="<?php echo ($data['type_image']); ?>">
                                        <input type="hidden" name="type_thumb" id="input-type_thumb-value" value="<?php echo ($data['type_thumb']); ?>">
                                        <span class="btn btn-success fileinput-button">
                                            <i class="glyphicon glyphicon-plus"></i>
                                            <span>添加商品描述</span>
                                            <!-- The file input field used as target for the file upload widget -->
                                            <input id="input-type_image" name="type" type="file" data-uploadurl="<?php echo U('upload');?>">
                                        </span>
                                        <?php if(isset($message['type_image'])): ?><label for="input-type_image" class="text-danger"><?php echo ($message['type_image']); ?></label><?php endif; ?>
                                    </div>
                                    <div class="class-sm-4">
                                        <img src="/laosan/Public/Thumb/<?php echo ($data['type_thumb']); ?>" alt="" id="show-type" class="img-thumbnail" style="max-height: 50px; <?php if($data['type_thumb'] == ''): ?>display:none;<?php endif; ?>" />
                                    </div>
                                </div>

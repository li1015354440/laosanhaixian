                            ...
                            <table class="table table-bordered table-hover">
                                ...
                                <?php if(is_array($rows)): $i = 0; $__LIST__ = $rows;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><tr>
                                        <td class="text-center">
                                            <input type="checkbox" name="selected[]" value="<?php echo ($row['admin_id']); ?>" />
                                        </td>
                                         <td class="text-left"><?php echo ($row['admin_id']); ?></td> <td class="text-left"><?php echo ($row['name']); ?></td> <td class="text-left"><?php echo ($row['level']); ?></td>
                                        <td class="text-right">
                                                                                    <a href="<?php echo U('set',['admin_id'=>$row['admin_id']]);?>" data-toggle="tooltip" title="编辑" class="btn btn-primary"><i class="fa fa-pencil"></i></a>
                                                                                </td>

        ...
        <div class="page-header">
            <div class="container-fluid">
                <div class="pull-right">
                    <button type="button" data-toggle="tooltip" title="确认发货" class="btn btn-info" id="button-delete" onclick ="confirm('确认已发货？')? $('#form-list').submit(): false;">
                        确认发货
                    </button>
                </div>
                <h1>订单管理</h1>
                                ...
                                <?php if(is_array($rows)): $i = 0; $__LIST__ = $rows;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><tr>
                                        ...
                                        <td class="text-left">
                                          姓名:<?php echo ($row['recept_id']['recept_name']); ?> 电话:<?php echo ($row['recept_id']['tel']); ?>
                                           地址:<?php echo ($row['recept_id']['province']); echo ($row['recept_id']['city']); echo ($row['recept_id']['detail']); ?>
                                        </td>
                                        <td class="text-left">

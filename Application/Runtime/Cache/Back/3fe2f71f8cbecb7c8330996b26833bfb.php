                            ...
                            <table class="table table-bordered table-hover">
                                ...
                                <?php if(is_array($rows)): $i = 0; $__LIST__ = $rows;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><tr>
                                        <td class="text-center">
                                         ...
                                         <td class="text-left"><?php echo ($row['type_id']); ?></td>
                                         <td class="text-left"><?php echo ($row['is_online']); ?></td>
                                         <td class="text-left"><?php echo ($row['name']); ?></td>
                                         <td class="text-left"><?php echo ($row['shop_price']); ?></td>
                                        ...
                                        </td><td class="text-left"><?php echo ($row['image']); ?></td>
                                        <td class="text-left"><?php echo ($row['thumb']); ?></td>
                                        <td class="text-left"><?php echo ($row['description']); ?></td>
                                        <td class="text-left"><?php echo ($row['create_at']); ?></td>
                                        <td class="text-right">
                                            <a href="<?php echo U('set',['goods_id'=>$row['goods_id']]);?>" data-toggle="tooltip" title="编辑" class="btn btn-primary"><i class="fa fa-pencil"></i></a>
                                        </td>

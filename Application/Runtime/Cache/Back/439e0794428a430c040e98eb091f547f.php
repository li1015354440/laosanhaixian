        ...
        <div class="page-header">
            <div class="container-fluid">
                <div class="pull-right">
                    <a href="<?php echo U('set');?>" data-toggle="tooltip" title="新增" class="btn btn-primary"> <i class="fa fa-plus"></i>
                    </a>
                            ...
                            <table class="table table-bordered table-hover">
                                ...
                                <tr>
                                    ...
                                    <td class="text-left">
                                        ...
                                        <a href="<?php echo sortU('list',$filter,$sort,'sort_number');?>" class="<?php echo sortClass($sort,'sort_number');?>">排序</a>
                                    </td>
                                    <td class="text-left">
                                        图片
                                    </td>
                                ...
                                <?php if(is_array($rows)): $i = 0; $__LIST__ = $rows;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><tr>
                                        <td class="text-center">
                                            <input type="checkbox" name="selected[]" value="<?php echo ($row['series_id']); ?>" />
                                        </td>
                                        <td class="text-left"><?php echo ($row['series_id']); ?></td>
                                        <td class="text-left"><?php echo ($row['title']); ?></td>
                                        <td class="text-left"><?php echo ($row['is_display']); ?></td>
                                        <td class="text-left"><?php echo ($row['sort_number']); ?>
                                        </td>
                                        <td class="text-left"width="100" height="100">
                                            <img   src="/Public/Thumb/<?php echo ($row['series_thumb']); ?>">
                                        </td>
                                        <td class="text-right">
                                            <a href="<?php echo U('set',['series_id'=>$row['series_id']]);?>" data-toggle="tooltip" title="编辑" class="btn btn-primary"><i class="fa fa-pencil"></i></a>
                                        </td>
